...
\item Install Apertium %Apertium setup
\end{enumerate}

\subsection{place conference room 13-16}

\begin{enumerate}
\item How does machine translation work? - Step-by-step walk through of the machine translation process%Apertium system
...
\begin{enumerate}
\item Ávvir in lulesámi - spotting errors
\item How to report errors
\item The bilingual dictionary
\end{enumerate}

\subsection{place lab 13-16}

\begin{enumerate}
\item Syntactic transfer
\item Linguistic questions - SOV vs. SVO etc.
\item Discussion
\end{enumerate}
